...
import { safeCurrency } from '@/lib/utils'
      ...
      {activeTab === 'overview' && (
        <div className="glass-card p-6 space-y-4">
          {[
            ...
            { label: 'Jackpot', value: safeCurrency(draw.jackpotAmount) },
            ...
            draw.winners.map(winner => (
              <div key={winner.id} className={`glass-card p-5 flex flex-wrap items-center gap-4 border ${
                ...
                <div className="text-right">
                  <p className="font-mono text-yellow-400 font-bold">{safeCurrency(winner.prizeAmount)}</p>
                  {winner.verified ? (
