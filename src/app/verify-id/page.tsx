        ...
        <div className="flex items-center justify-center min-h-screen px-4">
          <div className="glass-card p-10 max-w-md w-full text-center">
            ...
            <p className="text-white/50 mb-6 leading-relaxed">
              Your ID document has been submitted and is being reviewed by our
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-10">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(67,97,238,0.2), rgba(67,97,238,0.05))",
            ...
            <p className="text-white/50 max-w-md mx-auto">
              To protect all players and comply with regulations, we require a
              one-time identity verification before you can purchase tickets.
            </p>
          </div>
          ...
          <div className="glass-card p-8 space-y-6">
            ...
            <div className="flex gap-3 p-4 rounded-xl bg-blue-500/5 border border-blue-500/15">
              ...
              <p className="text-white/40 text-xs leading-relaxed">
                Your document is encrypted and stored securely. It is only
                accessible to authorized verification staff and is never shared
                with third parties.
              </p>
            </div>
